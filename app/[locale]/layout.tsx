...
export const metadata: Metadata = {
  title: {
    default: "Howyeah Admin | RANK AI",
    template: "%s | Howyeah Admin",
  },
  description:
    "Private admin dashboard for RANK AI by Howyeah — manage users, plans, subscriptions, billing, and platform settings.",
  icons: {
