    ...
    <Card className="gap-3">
      <CardContent className="flex flex-col gap-3">
        <div className="flex items-center justify-between gap-2">
          <TestimonialPlanBadge plan={testimonial.planKey} />
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-medium">{testimonial.customerName}</p>
            <TestimonialRatingStars rating={testimonial.rating} />
          </div>
        </div>
        <p className="line-clamp-3 text-sm text-muted-foreground">{testimonial.comment}</p>
      </CardContent>
