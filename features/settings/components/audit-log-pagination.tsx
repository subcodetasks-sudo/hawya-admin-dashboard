...
export default function AuditLogPagination({ params, onPageChange }: Props) {
  const t = useTranslations("Settings");
  const locale = useLocale();
  const { data, isLoading } = useQuery(auditLogQueryOptions(params));
